...
A("link8", "", "", "AGPM.html", document.getElementById("nav"))
Button("", "tab", "AGPM", "", document.getElementById("link8"))
A("link9", "", "", "allversiondownloads.html", document.getElementById("nav"))
Button("", "tab", "All version downloads", "", document.getElementById("link9"))
Meta('description', 'We make software like text editors, programming languages, notes programs and a ui framework (automated ahh metadata)')
